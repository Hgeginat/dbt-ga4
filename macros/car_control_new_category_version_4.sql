...
case 
    ...
    (TRIM(content_type) ='refresh_page' AND TRIM (item_id) = 'refresh_page' AND TRIM (item_category) = 'App:carcontrol' ) OR 
    (TRIM(content_type) ='refresh_page' AND TRIM (item_id) = 'page_refresh' AND TRIM (item_category) = 'App:carcontrol' ) OR 
   ...
   WHEN
    ...
    (TRIM(content_type) ='page_view' AND TRIM (item_id) = 'charge_page_view' AND TRIM (item_category) = 'App:carcontrol:charge' ) OR 
    (TRIM(content_type) ='page_view' AND TRIM (item_id) = 'charge_schedule_page_view' AND TRIM (item_category) = 'App:carcontrol:charge' ) OR 
